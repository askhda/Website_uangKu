    ...
    <div class="gambar">
      ...
      <main class="container">
        ...
        <div class="card p-2" style="background-color: #F0EBCC; margin-right: 25%; margin-left: 25%;">
          <div class="card-body">
            <h3 class="text-center nunito biru_tua fw-bold">Cek Password!</h3>
            <br>
            <form method="POST" action="">
              ...
              <div class="text-center">
                <button type="submit" name="submit" class="btn btn-lg nunito biru_tua biru_elektrik">Cek</button>
              </div>
            </form>
            <br>
            <!---- Proses hasil ----->
            ...
            if (isset($_POST['submit'])) {
              $nama = $_POST['username'];
              $data_pass = "SELECT * FROM `pengguna` WHERE (`username`='$nama')";
              $data = $conn->query($data_pass);
              if ($data->num_rows > 0) {
              ...
              <span class="roboto biru_tua">Password kamu adalah
            ...
            ?>
            <br><br>
            <span class="roboto biru_tua">Sudah cek password?
